...
# Get BOT_TOKEN and ADMIN_ID from hardcoded values
BOT_TOKEN = "7801237842:AAFw-..." # Replace with your bot token
ADMIN_ID = "123456789" # Replace with your admin user ID

if not BOT_TOKEN or BOT_TOKEN == "7801237842:AAFw-...":
    print("Error: BOT_TOKEN is not set.")
    print("Please set the BOT_TOKEN in bot.py.")
    exit(1)
